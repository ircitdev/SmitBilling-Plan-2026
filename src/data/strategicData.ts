...
export const METADATA = {
  version: '1.6 от 22.09.2026',
  build: 'Build 3359 · v3.7.0',
  ...
  // планы работ живут в биллинге, раздел «Разработка и логи» → Планы
  paritetUrl: 'https://billing.smit34.ru/plan2026/plans/roadmap-paritet/',
  compareLanbillingUrl: 'https://billing.smit34.ru/plan2026/compare/lanbilling/',
  compareCarbonUrl: 'https://billing.smit34.ru/plan2026/compare/carbon/'
};
...
export const COMPETITORS: Competitor[] = [
  {
    ...
    price: 'Публичный прайс: 500 аб. — от 41 561 ₽, 3000 аб. — 92–184 тыс. ₽ (редакции S1–S4)',
    stack: 'Firebird legacy → новый Carbon 5 стек',
    sormCert: 'Сертификат связи ОС-1-СТ-0866 до 01.04.2028 · реестр ПО №6720',
    pros: [
      ...
      'Экосистема вокруг биллинга: Reductor DPI X (фильтрация по спискам РКН, 1200+ инсталляций, рекомендован Роскомнадзором), NetMon (мониторинг по зеркалу трафика), Provision (резервный сервер с переключением «на лету»)',
      'Аргумент «всё из коробки»: подписка без доплат за модули — прямой контрудар по модульной монетизации'
    ],
    cons: [
  ...
  },
  {
    ...
    price: 'Цены закрыты — лицензии и модули «по запросу» (градация до 500 / 1000 / 2000 / 5000 / 10000+ абонентов)',
    stack: 'C/C++ + MySQL',
    ...
    pros: [
      ...
      '25 модулей, из них 18 — коннекторы к чужим платформам: 7 IPTV, 2 CAS для кабельного ТВ, 2 домофонии, 1С, ЭДО «Диадок», СберБизнес, Trassir, гостиничная Fidelio',
      'Сервер печати чеков на физической ККТ — чего нет у нас; обмен с 1С у нас появился в 3.7.0, но формат ещё сверяется с живой «Бухгалтерией 3.0»'
    ],
    cons: [
      ...
      'Цены полностью закрыты — сравнить стоимость владения невозможно',
      'Inventory, Email Collector и модуль виртуализации не входят в подписку и докупаются отдельно'
    ],
...
export const RECOMMENDATIONS: Recommendation[] = [
  ...
  },
  {
    ...
    title: 'СОРМ: честная позиция вместо сертификата',
    summary: 'Сертификат выдаётся на технические средства СОРМ, а не на биллинг. От биллинга требуется выгрузка по приказу №573 — она реализована полностью и работает в бою.',
    intro: 'Требования СОРМ распадаются на три части, и путаница возникает оттого, что все три называют одним словом. Техническое средство — железо в сети оператора, на него и выдаётся сертификат. Сведения об абонентах в формате приказа №573 — зона биллинга, здесь работаем мы. Организационная часть — план взаимодействия с территориальным органом — к программе отношения не имеет.',
    why: 'За полтора года переговоров письменного требования «сертифицированный биллинг» не предъявил никто. Испытания стоили бы 500 тыс. – 1,2 млн ₽ и 6–12 месяцев, а сертификат выдаётся на конкретную версию — при еженедельных релизах он устареет раньше, чем окупится. Начинаем разговор о сертификации, если появится клиент с письменным требованием от территориального органа и готовностью участвовать в расходах.',
    impactScore: 74,
    effortScore: 12,
    quadrant: 'quick_wins',
    quadrantLabel: 'Быстрая победа',
    ...
    roiRatio: 6.2,
    budget: {
      time: 'позиция сформулирована, сертификация — по триггеру',
      money: '0 ₽ сейчас; 500 тыс. – 1,2 млн ₽ при запуске испытаний',
      team: 'продажи (готовые ответы), при запуске — эксперты ЦНИИС'
    },
    steps: [
      {
  ...
  },
  {
    ...
    title: 'Миграторы из конкурентов',
...
export const ROADMAP_ITEMS: RoadmapItem[] = [
  ...
  {
    id: 'rd40',
    title: 'Подписание договора на телефоне с кодом из СМС',
    description: 'Клиент подписывает договор пальцем на экране телефона монтажника прямо при подключении и подтверждает подпись одноразовым кодом из СМС — простая электронная подпись по 63-ФЗ, соглашение о ней входит в договор. PDF со штампом попадает в реестр, копия уходит клиенту письмом и СМС. Первая версия — физлица с паспортными данными.',
    status: 'done',
    statusLabel: 'Готово · Build 3294–3314',
    category: 'core',
    build: '3294-3314'
  },
  {
    id: 'rd35',
    title: 'Сводки и дашборды на общих компонентах',
    description: 'Главная, Панель директора, дашборды CRM и Поддержки, AI-агент, отчёты Поддержки и аналитика склада собраны из одних карточек показателей и блоков, с единым выбором периода. Цифры сходятся между страницами: поступления и ARPU считаются по одному правилу, прошлый период — той же длины, обещанный платёж и сторно больше не раздувают выручку.',
    status: 'done',
    statusLabel: 'Готово · Build 3337–3359 (v3.7.0)',
    category: 'ux',
    build: '3337-3359'
  },
  {
    ...
    description: 'Группы сотрудников со своим значком и цветом, окно сотрудника с организациями и почтовым ящиком, политика паролей для всех сотрудников (пароль становится и паролем почты), журнал правок прав и доступа к папкам клиентов.',
    status: 'done',
    statusLabel: 'Готово · Build 2383–2385, 3299–3314',
    category: 'compliance',
    build: '3299-3314'
  },
  {
    id: 'rd37',
    title: 'Карта сети: опоры, техвозможность, план выездов',
    description: 'Реестр опор, проверка техвозможности подключения по адресу заявки, обзвон и план выездов с графиком монтажников: выезд перетаскивается между бригадами, маршрут считается по дорогам, план утверждает главный инженер.',
    status: 'done',
    statusLabel: 'Готово · Build 3027–3126',
    category: 'network',
    build: '3027-3126'
  },
  {
    id: 'rd38',
    title: 'Рассылки по расписанию с согласованием',
    description: 'Запланированная рассылка проходит согласование, её можно изменить до отправки, черновик текста пишет AI. Подставленные в текст значения сохраняются в истории клиента — раньше в кабинете оставались служебные шаблоны.',
    status: 'done',
    statusLabel: 'Готово · Build 3067–3139',
    category: 'core',
    build: '3067-3139'
  },
  {
    id: 'rd39',
    title: 'Закрытое хранилище и обезличенный демо-стенд',
    description: 'Персональные загрузки и резервные копии перенесены в закрытый бакет с временными ссылками. Демо-стенд полностью обезличен: сгенерированные клиенты и юрлица, свой ключ шифрования, отключён от боевых почты, касс и мессенджеров.',
    status: 'done',
    statusLabel: 'Готово · Build 3146',
    category: 'infra',
    build: '3146'
  },
  {
  ...
  },
  {
    ...
    status: 'done',
    statusLabel: 'Готово · Build 2013–2029, 3246–3277',
    category: 'core',
    build: '2013-2029'
  },
  {
  ...
  {
    id: 'rd26',
    title: 'Мигратор из Mikbill',
    description: 'Перенос клиентов, тарифов, балансов и истории платежей из Mikbill — системы, с которой чаще всего уходят провайдеры нашего сегмента. Потоковое чтение дампа, сверка контрольных сумм, режим проверки без записи.',
    status: 'done',
    statusLabel: 'Готово',
    category: 'core'
  },
  {
    id: 'rd27',
    title: 'Юридический контур: Роспатент и реестр ПО',
    description: 'Комплект заявки на регистрацию программы для ЭВМ собран: реквизиты сверены с ЕГРЮЛ, реферат уложен в 700 знаков, депонируемые материалы собираются командой — ровно 70 страниц, с автоматическим закрытием ключей и телефонов. Заявка в реестр российского ПО готова, кроме свидетельства Роспатента — оно единственный блокер.',
    status: 'partial',
    statusLabel: 'Комплект готов, подача за директором',
    category: 'core'
  },
  {
    id: 'rd28',
    title: 'Материалы для первых продаж',
    description: 'Список 20 целевых провайдеров Юга России с юрлицами и опознанными системами, инструкция подключения кассы клиента, черновики трёх публикаций, позиция по СОРМ для переговоров. Всё, что нужно менеджеру до первого звонка.',
    status: 'done',
    statusLabel: 'Готово',
    category: 'core'
  },
  ...
  {
    id: 'rd29',
    title: 'Обмен с 1С:Предприятие 8.3',
    description: 'Модуль onec сделан и работает на проде (сентябрь 2026): контрагенты, договоры, счета, акты и платежи выгружаются в типовом формате EnterpriseData для штатной «Синхронизации данных» «Бухгалтерии 3.0», с журналом обменов и обучающим роликом. Пробел №1 против LANBilling закрыт по функции. Осталось подтвердить формат загрузкой в живую базу БП 3.0 — без неё не обещаем клиенту «загрузится с первого раза».',
    status: 'partial',
    statusLabel: 'Модуль готов · ждёт сверки с живой БП 3.0',
    category: 'finance',
    priority: 'HIGH',
    planUrl: 'https://billing.smit34.ru/plan2026/plans/onec/'
  },
  {
    id: 'rd30',
    title: 'IPTV-платформы вендор-паками',
    description: 'Новая ТВ-платформа подключается данными с сервера лицензий, а не релизом биллинга: JSON-описание API панели исполняет универсальный драйвер — механика вендор-паков СОРМ. У Carbon и LANBilling по 7 коннекторов, у нас нативно два. Первым шагом — развязка от двух зашитых провайдеров: строки tvip и lfstream сидят в 19 файлах и 5 шаблонах. Блокер — тестовый доступ к панели.',
    status: 'blocked',
    statusLabel: 'План 17–25 дней · нужен доступ к панели',
    category: 'network',
    priority: 'HIGH',
    planUrl: 'https://billing.smit34.ru/plan2026/plans/iptv-packs/'
  },
  {
    id: 'rd31',
    title: 'Платёжные каналы — реестр драйверов',
    description: 'Сейчас три пути приёма платежей (ЮKassa, Wallet One, универсальный webhook) против заявленных конкурентом 150+. Реестр платёжных провайдеров по образцу телефонии и IPTV плюс три-пять ходовых коннекторов: новый канал становится настройкой, а не разработкой.',
    status: 'planned',
    statusLabel: 'План 2–3 недели',
    category: 'finance',
    priority: 'HIGH'
  },
  {
    id: 'rd32',
    title: 'Горячий резерв биллинга',
    description: 'Реплика базы и скрипты переключения есть, но код на резерв не переносится — это план восстановления, а не переключение «на лету», которое Carbon продаёт отдельным продуктом Provision. Довести до продукта: перенос кода и конфигурации, проверка готовности резерва, переключение по кнопке и регулярные учения.',
    status: 'planned',
    statusLabel: 'План 3–4 недели',
    category: 'infra',
    priority: 'MED'
  },
  {
    id: 'rd33',
    title: 'Физическая касса и рабочее место кассира',
    description: 'Печать чека на ККТ с фискальным накопителем в офисе: агент на кассовом ПК держит исходящий long-poll к биллингу (как SMS-шлюз на Android), печатает через драйвер и возвращает фискальные реквизиты. Отдельный модуль kassa с квотой устройств — продуктовая опция для клиентов. Внутри готово больше половины: фабрика провайдеров, состав чека, очередь и ретраи.',
    status: 'planned',
    statusLabel: 'План 26–38 дней',
    category: 'finance',
    priority: 'MED',
    planUrl: 'https://billing.smit34.ru/plan2026/plans/kassa/'
  },
  {
    id: 'rd34',
    title: 'Диагностика абонента и статус фильтрации',
    description: 'У Carbon отдельный продукт NetMon: зеркало трафика, задержки и повторные передачи по абоненту, поиск источников аномалий. Свой разбор пакетов не строим — собираем то, что уже приходит от RADIUS и оборудования, в один экран диагностики и связываем с тикетом Поддержки. Рядом — статус фильтрации по спискам РКН и результатов «Ревизора» в биллинге: сам фильтр остаётся клиентским.',
    status: 'planned',
    statusLabel: 'План 2–3 недели + 1–2 недели',
    category: 'network',
    priority: 'MED'
  }
];
...
export const PODCAST_EPISODES: PodcastEpisode[] = [
  {
    id: 'digital-contract',
    title: 'Цифровой договор и логистика выездов',
    subtitle: 'Выпуск 3.7.0: договор на телефоне с кодом из СМС и путь заявки до подключения',
    url: 'https://storage.googleapis.com/uspeshnyy-projects/smit/billing/audio/podcast_digital_contract.m4a',
    duration: '26 минут',
    badge: 'Новое',
    topics: [
      { time: '00:00 – 03:00', text: 'Зоопарк программ у провайдера: CRM, старый биллинг и склад в таблицах.' },
      { time: '03:00 – 09:00', text: 'Бумажный договор и его потери; подпись пальцем на экране, код из СМС, PDF со штампом.' },
      { time: '09:00 – 12:00', text: 'Честные границы: пока только физлица с паспортными данными в карточке.' },
      { time: '12:00 – 18:00', text: 'Техвозможность, план выездов по реальным дорогам, календарь в телефоне монтажника, склад по серийным номерам.' },
      { time: '18:00 – 26:12', text: 'Обмен с 1С на пилоте, AI-диагностика на первой линии и скрытые убытки от ручного ввода.' },
    ],
  },
  {
    id: 'zoo-debate',
    title: 'Дебаты: СмИТ Биллинг против зоопарка систем',
    subtitle: 'Скептик и сторонник спорят, стоит ли переходить на единую платформу',
    url: 'https://storage.googleapis.com/uspeshnyy-projects/smit/billing/audio/debate_zoo_of_systems.m4a',
    duration: '25 минут',
    badge: 'Новое',
    topics: [
      { time: '00:00 – 06:00', text: 'День монтажника и цена ошибок на стыках программ; единое окно вместо копирования данных.' },
      { time: '06:00 – 12:00', text: 'Можно ли доверять подписи на телефоне в правовом поле — и где ограничение первой версии.' },
      { time: '12:00 – 18:00', text: 'Склад под наряд и учёт роутеров; главный довод скептика — что будет, если единая система упадёт.' },
      { time: '18:00 – 25:30', text: 'Резервные копии, банковские выписки без ручного разнесения, AI на первой линии и итог: кому переход нужен сейчас.' },
    ],
  },
  {
    id: 'tradeoffs',
...
export const THREAT_RISKS_DATA: ThreatRisk[] = [
  {
    id: 'risk-sorm',
    code: 'RISK-01',
    name: 'Клиент требует сертификат на биллинг',
    category: 'regulatory',
    ...
    level: 'medium',
    levelLabel: 'Средний',
    description: 'Сертификат соответствия выдаётся на технические средства СОРМ, а не на биллинг: от биллинга требуется выгрузка по приказу №573, и она у нас есть. Риск в том, что клиент или его юрист толкуют требование шире и ждут сертификат на систему расчётов.',
