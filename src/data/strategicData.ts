...
export const COMPETITORS: Competitor[] = [
  ...
  },
  {
    ...
    pros: [
      ...
      'Обмен с 1С:Бухгалтерия 3.0 и сервер печати чеков на физической ККТ — чего нет у нас'
    ],
    cons: [
...
export const ROADMAP_ITEMS: RoadmapItem[] = [
  ...
  },
  {
    ...
    description: 'Модуль onec: контрагенты, договоры, счета, акты и платежи уезжают в «Бухгалтерию 3.0» типовым форматом EnterpriseData — штатной «Синхронизацией данных», без доработки конфигурации у клиента. Пробел №1 против LANBilling: бухгалтерия переносит данные руками каждый месяц. Блокер — нужна реальная база БП 3.0 для пилота, формат подтверждается только загрузкой.',
    status: 'blocked',
    statusLabel: 'План 16–24 дня · нужна пилотная база',
    category: 'finance',
    priority: 'HIGH',
