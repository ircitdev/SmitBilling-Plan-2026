...
export const StrengthsSection: React.FC<StrengthsSectionProps> = ({ onOpenSormDrawer }) => {
  return (
    <section id="strengths" className="mb-14 scroll-mt-20">
      ...
      {/* Bento Grid */}
      <ScrollStagger staggerDelay={0.06} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8">
        {/* Card 1: AI Agent (Full width on top) */}
        <ScrollStaggerItem distance={20} className="md:col-span-2 lg:col-span-3">
          <div className="p-6 sm:p-8 rounded-[32px] bg-gradient-to-br from-emerald-500/10 via-teal-500/5 to-emerald-500/10 dark:from-emerald-950/50 dark:via-slate-900 dark:to-teal-950/40 border border-emerald-500/30 dark:border-emerald-500/30 shadow-sm">
        ...
        <ScrollStaggerItem distance={20} className="h-full">
          <div className="p-6 sm:p-7 rounded-[32px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between hover:border-slate-300 dark:hover:border-slate-700 transition-colors h-full">
            <div>
