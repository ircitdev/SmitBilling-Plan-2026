  ...
  return (
    <section id="tldr" className="mb-14 scroll-mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        ...
        <div className="md:col-span-2 p-6 sm:p-8 rounded-[32px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5 text-sm text-slate-700 dark:text-slate-300">
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-800 flex flex-col justify-between hover:border-emerald-500/30 transition-all">
              <div>
        ...
        <div className="md:col-span-2 relative overflow-hidden p-7 sm:p-9 rounded-[32px] bg-slate-900 text-white dark:bg-slate-900 border border-slate-800 shadow-xl">
