  ...
  return (
    <section id="weaknesses" className="mb-14 scroll-mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 mb-6">
        ...
        <div className="p-6 rounded-[28px] bg-rose-50/50 dark:bg-rose-950/20 border border-rose-200/80 dark:border-rose-900/50 flex flex-col justify-between shadow-xs">
          <div>
        ...
        <div className="p-6 rounded-[28px] bg-gradient-to-br from-amber-50/90 via-amber-50/40 to-amber-100/60 dark:from-amber-950/30 dark:via-amber-950/15 dark:to-amber-950/30 border-2 border-amber-400/60 dark:border-amber-500/40 flex flex-col justify-between shadow-sm">
          <div>
            <div className="flex items-center gap-2.5 mb-2.5">
        ...
        <div className="p-6 rounded-[28px] bg-emerald-50/60 dark:bg-emerald-950/20 border border-emerald-200/80 dark:border-emerald-900/50 flex flex-col justify-between shadow-xs">
          <div>
            <div className="flex items-center gap-2.5 mb-2.5">
        ...
        {/* Item 7: No DPI */}
        <div className="p-6 rounded-[28px] bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex flex-col justify-between shadow-xs">
          <div>
            <div className="flex items-center gap-2.5 mb-2.5">
