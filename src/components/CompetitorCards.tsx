...
export const CompetitorCards: React.FC = () => {
  return (
    <section id="competitors" className="mb-14 scroll-mt-20">
      ...
      <ScrollStagger staggerDelay={0.08} className="space-y-6">
        {COMPETITORS.map((comp) => (
          <ScrollStaggerItem key={comp.id} distance={20}>
            <div
              className="p-6 sm:p-8 rounded-[32px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-emerald-500/40 dark:hover:border-emerald-500/40 hover:shadow-emerald-950/5 dark:hover:shadow-emerald-950/20"
            >
              {/* Top Header */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 pb-5 border-b border-slate-100 dark:border-slate-800">
                <div>
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[11px] font-mono font-bold px-3 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 transition-transform duration-200 hover:scale-105">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-6 text-xs">
                <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-850 border border-slate-200/60 dark:border-slate-800 transition-all duration-200 hover:-translate-y-1 hover:shadow-sm hover:border-emerald-500/40 hover:bg-white dark:hover:bg-slate-800">
              ...
              {/* Pros & Cons with Bento Hover Lift */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                <div className="p-5 rounded-2xl bg-emerald-50/60 dark:bg-emerald-950/30 border border-emerald-200/70 dark:border-emerald-800/60 transition-all duration-200 hover:-translate-y-1 hover:shadow-md hover:border-emerald-300 dark:hover:border-emerald-700">
                ...
                <div className="p-5 rounded-2xl bg-rose-50/60 dark:bg-rose-950/30 border border-rose-200/70 dark:border-rose-800/60 transition-all duration-200 hover:-translate-y-1 hover:shadow-md hover:border-rose-300 dark:hover:border-rose-700">
              ...
              <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 dark:bg-slate-850 border border-slate-200/70 dark:border-slate-800 text-xs sm:text-sm text-slate-700 dark:text-slate-300 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm hover:border-emerald-500/30">
